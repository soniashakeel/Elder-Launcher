...
public class LauncherActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ELDER LAUNCHER can route directly into the upstream, fully functional
        // authentication and launch pipeline without duplicating Pojav's
        // account/token/download logic in the Compose shell.
        getSupportFragmentManager().executePendingTransactions();
        if (getIntent().getBooleanExtra("elder_open_auth", false)) {
            ExtraCore.setValue(ExtraConstants.SELECT_AUTH_METHOD, true);
        }
        String elderAuthMode = getIntent().getStringExtra("elder_auth_mode");
        if ("microsoft".equals(elderAuthMode)) {
            Tools.swapFragment(this, MicrosoftLoginFragment.class, MicrosoftLoginFragment.TAG, null);
        } else if ("offline".equals(elderAuthMode)) {
            Tools.swapFragment(this, net.kdt.pojavlaunch.fragments.LocalLoginFragment.class,
                    net.kdt.pojavlaunch.fragments.LocalLoginFragment.TAG, null);
        }
        if (getIntent().getBooleanExtra("elder_autoplay", false)) {
